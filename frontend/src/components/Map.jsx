...
// Component to handle map centering when user joins
...
const Map = ({ users, currentUserCoords }) => {
  const defaultCenter = [0, 0];

  return (
    <div className="w-full h-full">
      <MapContainer 
        center={currentUserCoords || defaultCenter} 
        zoom={3} 
        zoomControl={false}
      ...
      >
        ...
        {currentUserCoords && <ChangeView center={currentUserCoords} />}
